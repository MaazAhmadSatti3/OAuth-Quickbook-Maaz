...
// src/functions/storeCredentials/handler.ts
__export(exports, {
  main: () => main
});
...
var storeCredentials = async (event) => {
  ...
  const dynamoClient = process.env.IS_OFFLINE ? new AWS.DynamoDB.DocumentClient({
    region: "localhost",
...
var main = middyfy(storeCredentials);
